...
urlpatterns = [
    ...
    path('foodsevice/<str:title>/', FoodserviceDetailView.as_view(), name="foodservice_detail"),
    path('foodsevice/<str:title>/update', FoodserviceUpdateView.as_view(), name="foodservice_update"),
